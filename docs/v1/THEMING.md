...
The `./v1/theme` and `./v1/tokens` subpaths contain no React runtime and are safe
for server data modules. The main `./v1` entry is the convenient React client
surface because it also exports the provider and hooks.
